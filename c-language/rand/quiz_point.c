...
int main(void) 
{
    ...
    {
        {"다음 중 생물학적 과일이 아닌 것은?", {"수박", "토마토", "오이", "사과", "포도", "바나나", "멜론", "딸기", "파인애플", "루바브"}, 10},
        ...
        {"다음 중 바다에 속하지 않는 것은?", {"태평양", "대서양", "흑해", "인도양", "북극해", "카리브해", "아마존 강", "홍해", "발트해", "남극해"}, 7},
        {"다음 중 일본의 수도는?", {"오사카", "교토", "도쿄", "삿포로", "나고야", "히로시마", "후쿠오카", "고베", "센다이", "요코하마"}, 3},
        {"다음 중 태양계의 행성이 아닌 것은?", {"지구", "화성", "목성", "금성", "수성", "달","천왕성", "해왕성", "명왕성", "태양"}, 6},
        {"다음 중 한국의 전통 음식이 아닌 것은?", {"김치", "불고기", "비빔밥", "떡국", "초밥","갈비", "된장찌개", "삼계탕", "불낙전골", "순두부찌개"}, 5},
        {"다음 중 인도의 수도는?", {"뭄바이", "벵갈루루", "첸나이", "콜카타", "푸네", "아마다바드", "수라트", "자이푸르", "델리","러크나우"}, 9},
        {"다음 중 미국의 수도는?", {"뉴욕", "로스앤젤레스", "시카고", "휴스턴", "필라델피아", "피닉스", "워싱턴 D.C.","샌안토니오", "샌디에고", "댈러스"}, 7}
    };

    printf("문제를 시작합니다. 언제든 프로그램을 종료하고 싶으시다면 숫자 이외의 값을 입력해주세요.\n\n");
